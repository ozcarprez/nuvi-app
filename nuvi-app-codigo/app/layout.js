...
export const metadata = {
  title: 'Nuvi — Caja de saldo prepago para negocios',
  description: 'Tus clientes recargan saldo hoy, tú recibes el efectivo hoy. Panel de caja con bono para negocios de Tijuana.',
};
